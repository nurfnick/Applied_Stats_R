...
\end{align}
$$
I have added the library boot to my packages that I load at the beginning of the document.  In order to run the boot command you have to pass it a function that can be sub-divided.  Essentially you just have to pass it a function that slices the dataset.  Mimic what I do below and you should be golden!
