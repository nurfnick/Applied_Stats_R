...
One-way ANOVA will examine the means of a quantitative variable by examining the variance among the groups.  We should be comparing more than two groups (for two groups do the hypothesis test of module 0).  We could do this by hand but no body does so I am not going to bother either.  The null hypothesis for this will always be that all means are equal while the alternative is that there are at least two that are not equal.  Be careful with this as some treatments may still have equal means but not all are equal.
