...
```
Such a nicer, usable table!  I needed the tidyverse library to do this but I think it was worth it.  You should also notice that I created a function for doing the percent too!
